    ...
    <div className="flex flex-col gap-5 bg-slate-900 border border-slate-800 p-4 sm:p-6 rounded-xl shadow-xl transition-all">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-3 border-b border-slate-800/80">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          <div className="markers-mode-box flex flex-wrap items-center gap-1.5 p-1.5 rounded-lg border border-slate-800 w-full sm:w-auto max-w-full">
            <span className="marker-label text-[11px] font-bold text-slate-400 px-1.5 flex items-center gap-1 shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-1">
              {(['AUTO', 'DAILY', 'WEEKLY', 'MONTHLY', 'YEARLY', 'ALL', 'OFF'] as const).map((mode) => (
                <button
                  ...
                  className={`px-2 py-1 rounded text-[11px] transition shrink-0 ${
                    markerMode === mode
                      ? 'active-marker-btn bg-emerald-600 text-white shadow font-extrabold'
                      : 'unselected-marker-btn text-slate-300 hover:text-slate-100 font-bold'
                  }`}
                >
